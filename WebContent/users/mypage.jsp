...
$(document).ready(function(){
	  ...
	  <% List<UserDTO> a=(List<UserDTO>)request.getAttribute("user"); 
	  UserDTO dto= a.get(0);
...
<div class="my_container">    
  ...
  <div class="w3-row 1">
	...
	<!-- 내계정 설정 -->
	   <section class="gmain pay" style="min-height: 650px;">

      <div class="g_left" id="pay_left">
         <form action="/semiproject/user/UpdateMember" method="post">
            <section class="part">
<c:forEach var="user" items="${requestScope.user}">
               ...
               <div class="m_grid">
                  ...
                  <div class="m_justify_list">
                     <div class="inputs">
                        ...
                        <div>
                           <select id="country" name="country" data-selected-value="KR">
                  ...
                  <div>
                     <div class="inputs">
                        <div class="inputs g_ib">
                           <header> 국가코드* </header>
                           <select id="phone" name="p_country" data-selected-value="82">
                  ...
                  <div class="m_justify_list">
                     <div class="inputs">
                        ...
                        <input type="email" name="myemail" placeholder="이메일 주소" value="${user.myemail}">
                     	...
                     	<input type="submit" class="btn btn-warning" id="updateAccount" value="저장" style="width: 70px;height: 40px;"/>
                  </div>
               </div>
               </c:forEach>
               </section>
			...
			<br>
			 ...
			 <section class="pass_pay" style="min-height: 500px;">
			 	<form action="/semiproject/user/UpdateMyPwd" id="pass" class="pass" method="post">
			 	<header>
			 		<div class="pas_name">
			 		<div class="he">
			 		<h4>비밀번호 변경</h4>
			 		<p>비밀번호는 영문과 숫자를 포함해 최소 8-20자이어야 합니다</p>
			 		</div>
			 		</div>

			 		<br>
			 		<div class="c_2">
			 		<div class="pass_input">현재비밀번호</div>
			 		<input type="password" name="now_pwd"class="now_pass" placeholder="현재 비밀번호를 입력하세요"/>
			 		</div>
			 		<br>
			 		<div class="c_3">
			 		<div class="pass_re">새 비밀번호 (비밀번호는 영문과 숫자를 포함해 최소 8-20자이어야 합니다.)</div>
			 		<input type="password" name="pwd"class="re_pass" placeholder="새비밀번호를 입력하세요"/>
			 		<br/>
			 		<input type="password" name="pwd1" class="rere_pass" placeholder="새비밀번호를 다시 입력하세요"/>
			 		</div>
			 		<div class="btn">
			 		<input type="submit" class="btn btn-warning" id="updatePwd" value="저장" style="width: 70px;height: 40px;"/>
			 		</div>
			 	</header>
			 	</form>
			 </section>
